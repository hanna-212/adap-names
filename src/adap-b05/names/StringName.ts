...
export class StringName extends AbstractName {
    ...
    public insert(i: number, c: string) {
        ...
        MethodFailedException.assert(this.getNoComponents() === components.length, "InsertComponent failed");
    ...
    public append(c: string) {
        ...
        // src\adap-b05\names\StringName.tsthis.getComponent(this.getNoComponents() - 1) === c, "Appending component failed");
